...
│                                                                                  │
│   ┌────────────────────────┐                    ┌─────────────────────────────┐  │
│   │ Sensors / Measurements │                    │  BLE SoC / MCU              │  │    
│   | - T/H Sensor           |                    │  - BLE radio + stack        │  │
│   │ - VOC / Gas            │                    │  - App logic / scheduling   │  │
│   | - Lux Sensor           |                    │  - Sensor polling           │  │
│   │ - (Optional):          │◄── I²C / GPIO ────►│  - Power state control      │  │
│   │  - Pressure Sensor     │      / ADC         |  - Secure storage / IDs     |  |
|   |  - dB / Sound          |                    |                             |  |
|   |  - Battery Sense       |                    │                             │  │
│   └────────────────────────┘          ┌────────►│                             │  │
│                                       |         │                             │  │
