...
| VOC / IAQ (alternative) | [ScioSense ENS160](https://www.sciosense.com/wp-content/uploads/2023/12/ENS160-Datasheet.pdf) | 1.8V core, 3.3V I/O | — | 0.01 mA (DEEP SLEEP) | 2–2.5 mA (IDLE) | 29 mA (STANDARD) | Peak: 79 mA (<5 ms) | Requires 1.8V core rail |
