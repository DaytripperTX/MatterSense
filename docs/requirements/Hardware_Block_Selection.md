...
| [ST MP34DT06JTR](https://www.st.com/resource/en/datasheet/mp34dt06j.pdf) | Digital MEMS mic (PDM), port varies by package | • Common PDM mic option | • Distributor status indicates lifecycle risk (LTB / discontinuation flags) | • Icc: ~650 µA typ | $2.17 – $2.44 | Historical candidate snapshot; lifecycle status must be rechecked before reconsidering this non-baseline block |
